    ...
    <div className="min-h-screen bg-[#FEF9F2] flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl shadow-xl shadow-black/5 border border-stone-200 w-full max-w-md text-center">
        ...
        <div className="flex justify-center mb-6">
          <Image src="/logo.png" alt="InstaBill Logo" width={48} height={48} className="rounded-xl" />
        </div>
        
        <h1 className="text-2xl font-bold text-[#111827] mb-2">Sign in to InstaBill</h1>
        <p className="text-sm text-slate-500 mb-8">Access your invoicing dashboard instantly.</p>
